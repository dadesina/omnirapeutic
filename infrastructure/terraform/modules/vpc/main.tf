# VPC Module for Multi-AZ HIPAA-Compliant Infrastructure
...
# Private Subnets for Data Layer (Aurora, ElastiCache)
...
resource "aws_eip" "nat" {
  count  = 2 # Multi-AZ HA setup with 2 NAT Gateways
  domain = "vpc"
...
# Route Tables for Private App Subnets (one per NAT Gateway for HA)
...
# Route Tables for Private Data Subnets (no internet access)
